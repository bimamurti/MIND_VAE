...
parser.add_argument("--train", nargs='+', default=['data/continualdata_sandbox/task2/train'])
parser.add_argument("--test", nargs='+', default=['data/continualdata_sandbox/task2/test'])#/home/USER/Documents/projects/MIND_VAE/data/continualdata/data90d7/
...
parser.add_argument("--ckpt", type=str, default='log_eth/logproposed9april')
...
#parser.add_argument("--prev_data",default='log_eth/logrducibleloss15janv1')
parser.add_argument("--prev_data",type=str)
parser.add_argument("--datacapacity",type=str,default="50")#cek how capacity works
...
if __name__ == "__main__":
   ...
   # print("ok1")
    ...
    if(epoch==end_epoch):
        ...
        if finalcand:
            eps = 1e-8
            weightslast = finalcand[9]
            weightbcsr = finalcand[8]
            nc_comp = finalcand[6][:,1].float()
