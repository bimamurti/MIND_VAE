...
class BilevelCoreset:
    ...
    def build_with_representer_proxy_batch(self, X, y, m, kernel_fn_np, out_loss=None, data_weights=None,
       ...
       """
        ...
        if out_loss != None and n==50:
            out_loss.append(outer_loss)
        return selected_inds[:-1], coreset_weights.detach().numpy(), out_loss
