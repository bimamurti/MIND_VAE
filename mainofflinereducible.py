...
parser.add_argument("--ckpt", type=str, default='log_eth/testoffrelmorning')
...
#parser.add_argument("--prev_data",type=str,default="log_eth/testoffrel")
#parser.add_argument("--prev_data",default='log_eth/logcontinualsandboxoffrel_20260512_183542/logtask2')
...
if __name__ == "__main__":
    ...
    def loadallpreviousmemories(folder_path):
        ...
        train_files = glob.glob(os.path.join(folder, "bestREL.pt"))
        if(len(test_files)>0):
   ...
   # print("ok1")
    ...
    offline_REL.update_buffer_new_noduplicate()
