...
parser.add_argument("--train", nargs='+', default=['/home/USER/Documents/projects/MIND_VAE/data/crowdTraj/durimorning/train'])
parser.add_argument("--test", nargs='+', default=['/home/USER/Documents/projects/MIND_VAE/data/crowdTraj/durimorning/test'])
parser.add_argument("--frameskip", type=int, default=1)
parser.add_argument("--config", type=str, default='config/eth.py')
parser.add_argument("--ckpt", type=str, default='log_eth/duritest')
...
if __name__ == "__main__":
    ...
    if settings.test:
        ...
        test_dataset = Dataloader(
            ...
            batch_size=config.BATCH_SIZE, shuffle=False,idtask=0
        )
